...
;
DROP TABLE IF EXISTS BASIS_SET_DICTIONARY
;
DROP TABLE IF EXISTS BASIS_SET_TYPE_DICTIONARY
;
DROP TABLE IF EXISTS CALCULATION
;
DROP TABLE IF EXISTS CITATION
;
DROP TABLE IF EXISTS COMPUTATIONAL_METHOD_CLASS_DICTIONARY
;
DROP TABLE IF EXISTS COMPUTATIONAL_METHOD_DICT_CLASS_DICT
;
DROP TABLE IF EXISTS COMPUTATIONAL_METHOD_DICTIONARY
;
DROP TABLE IF EXISTS COMPUTATIONAL_METHOD_FAMILY_DICTIONARY
;
DROP TABLE IF EXISTS COMPUTING_ENVIRONMENT
;
DROP TABLE IF EXISTS ELEMENT_FAMILY_DICT
;
...
;
DROP TABLE IF EXISTS FORCE_FIELD_DICTIONARY
;
DROP TABLE IF EXISTS FORCE_FIELD_TYPE_DICTIONARY
;
DROP TABLE IF EXISTS FUNCTIONAL_GROUP_DICTIONARY
;
...
;
DROP TABLE IF EXISTS QM_METHOD_CLASS_DICTIONARY
;
DROP TABLE IF EXISTS QM_METHOD_DICTIONARY
;
DROP TABLE IF EXISTS QM_METHOD_DICTIONARY_CLASS_DICTIONARY
;
DROP TABLE IF EXISTS QM_METHOD_FAMILY_DICTIONARY
;
...
;
DROP TABLE IF EXISTS RESIDUE_DICT
;
...
;
DROP TABLE IF EXISTS SOFTWARE_DICTIONARY
;
DROP TABLE IF EXISTS STANDARD_DATA_GENERATING_METHOD
;
DROP TABLE IF EXISTS STANDARD_DATA_GENERATING_METHOD_TYPE
;
...
CREATE TABLE BASIS_SET_DICTIONARY
(
	id INTEGER NOT NULL AUTO_INCREMENT,
	name VARCHAR(50) NOT NULL,
...
CREATE TABLE BASIS_SET_TYPE_DICTIONARY
(
	id INTEGER NOT NULL,
	name VARCHAR(50),
	description TEXT,
...
CREATE TABLE COMPUTATIONAL_METHOD_CLASS_DICTIONARY
(
	id INTEGER NOT NULL,
	...
	family_id INTEGER,
	PRIMARY KEY (id),
	UNIQUE UQ_COMPUTATIONAL_METHOD_CLASS_DICTIONARY_id(id),
	KEY (family_id)
) 
;


CREATE TABLE COMPUTATIONAL_METHOD_DICT_CLASS_DICT
(
...
CREATE TABLE COMPUTATIONAL_METHOD_DICTIONARY
(
	id INTEGER NOT NULL,
	name VARCHAR(50),
	description VARCHAR(255),
	PRIMARY KEY (id),
	UNIQUE UQ_COMPUTATIONAL_METHOD_DICTIONARY_id(id)
) 
;


CREATE TABLE COMPUTATIONAL_METHOD_FAMILY_DICTIONARY
(
	id INTEGER NOT NULL,
	name VARCHAR(50) NOT NULL,
	description VARCHAR(255),
	PRIMARY KEY (id),
	UNIQUE UQ_COMPUTATIONAL_METHOD_FAMILY_DICTIONARY_id(id)
) 
;
...
CREATE TABLE ELEMENT_FAMILY_DICT
(
	id INTEGER NOT NULL AUTO_INCREMENT,
	name VARCHAR(50) NOT NULL,
	description TEXT,
...
CREATE TABLE FORCE_FIELD_DICTIONARY
(
	id INTEGER NOT NULL,
	name VARCHAR(255) NOT NULL,
	description VARCHAR(255),
	type_id INTEGER,
	is_coarse_grain BOOL,
	citation TEXT,
	PRIMARY KEY (id),
...
CREATE TABLE FORCE_FIELD_TYPE_DICTIONARY
(
	id INTEGER NOT NULL,
	name VARCHAR(50),
	description VARCHAR(255),
	...
	UNIQUE UQ_FORCE_FIELD_TYPE_DICTIONARY_name(name)
) 
;


CREATE TABLE FUNCTIONAL_GROUP_DICTIONARY
(
	id INTEGER NOT NULL,
	name VARCHAR(50),
	PRIMARY KEY (id),
...
CREATE TABLE QM_METHOD_CLASS_DICTIONARY
(
	id INTEGER NOT NULL AUTO_INCREMENT,
	...
	family_id INTEGER NOT NULL,
	PRIMARY KEY (id),
	UNIQUE UQ_QM_METHOD_CLASS_ID(id),
	UNIQUE UQ_QM_METHOD_CLASS_DICTIONARY_name(name),
	UNIQUE UQ_QM_METHOD_CLASS_DICTIONARY_short_name(short_name),
	KEY (family_id)
) 
;


CREATE TABLE QM_METHOD_DICTIONARY
(
	id INTEGER NOT NULL,
	name VARCHAR(50) NOT NULL,
	description VARCHAR(255),
	citation TEXT,
	PRIMARY KEY (id),
	UNIQUE UQ_QM_METHOD_DICTIONARY_id(id),
	UNIQUE UQ_QM_METHOD_DICTIONARY_name(name)
) 
;


CREATE TABLE QM_METHOD_DICTIONARY_CLASS_DICTIONARY
(
	method_id INTEGER NOT NULL,
	class_id INTEGER NOT NULL,
	PRIMARY KEY (method_id, class_id),
...
CREATE TABLE QM_METHOD_FAMILY_DICTIONARY
(
	id INTEGER NOT NULL,
	name VARCHAR(50) NOT NULL,
	description VARCHAR(255),
	PRIMARY KEY (id),
	UNIQUE UQ_QM_METHOD_FAMILY_DICTIONARY_id(id),
	UNIQUE UQ_QM_METHOD_FAMILY_DICTIONARY_name(name)
) 
;
...
CREATE TABLE SOFTWARE_DICTIONARY
(
	id INTEGER NOT NULL,
	name VARCHAR(50) NOT NULL,
	description VARCHAR(255),
...
CREATE TABLE STANDARD_DATA_GENERATING_METHOD
(
	id INTEGER NOT NULL,
	name VARCHAR(100),
	description VARCHAR(255),
...
CREATE TABLE STANDARD_DATA_GENERATING_METHOD_TYPE
(
	id INTEGER NOT NULL,
	name VARCHAR(50),
	description VARCHAR(255),
...
ALTER TABLE ATOM_OCCURRENCE ADD CONSTRAINT FK_ATOM_COMPOSITON_PERIODIC_TABLE 
	FOREIGN KEY (element_id) REFERENCES PERIODIC_TABLE (id)
;

ALTER TABLE BASIS_SET ADD CONSTRAINT FK_BASIS_SET_BASIS_SET_DICTIONARY 
	FOREIGN KEY (definition_id) REFERENCES BASIS_SET_DICTIONARY (id)
;
...
ALTER TABLE BASIS_SET_DICTIONARY ADD CONSTRAINT FK_BASIS_SET_DICT_TYPE_DICT 
	FOREIGN KEY (type_id) REFERENCES BASIS_SET_TYPE_DICTIONARY (id)
;
...
ALTER TABLE COMPUTATIONAL_METHOD_CLASS_DICTIONARY ADD CONSTRAINT FK_COMPUTATIONAL_METHOD_CLASS_DICT_FAMILY_DICT 
	FOREIGN KEY (family_id) REFERENCES COMPUTATIONAL_METHOD_FAMILY_DICTIONARY (id)
;

ALTER TABLE COMPUTATIONAL_METHOD_DICT_CLASS_DICT ADD CONSTRAINT FK_COMPUTATIONAL_METHOD_DICT_CLASS_DICT_REL_CLASS 
	FOREIGN KEY (class_id) REFERENCES COMPUTATIONAL_METHOD_CLASS_DICTIONARY (id)
;

ALTER TABLE COMPUTATIONAL_METHOD_DICT_CLASS_DICT ADD CONSTRAINT FK_COMPUTATIONAL_METHOD_DICT_CLASS_DICT_REL_METHOD 
	FOREIGN KEY (method_id) REFERENCES COMPUTATIONAL_METHOD_DICTIONARY (id)
;
...
ALTER TABLE EXPERIMENT_DATA_GENERATING_METHOD ADD CONSTRAINT FK_DATA_GEN_METHOD_STANDARD 
	FOREIGN KEY (reference_id) REFERENCES STANDARD_DATA_GENERATING_METHOD (id)
;
...
ALTER TABLE EXPERIMENT_PROCESS ADD CONSTRAINT FK_EXPERIMENT_PROCESS_EXPERIMENT 
	FOREIGN KEY (experiment_id) REFERENCES EXPERIMENT (id)
;

ALTER TABLE EXPERIMENT_PROCESS ADD CONSTRAINT FK_PROCESS_SYSTEM 
...
ALTER TABLE FORCE_FIELD ADD CONSTRAINT FK_FORCE_FIELD_FORCE_FIELD_DICTIONARY 
	FOREIGN KEY (reference_id) REFERENCES FORCE_FIELD_DICTIONARY (id)
;
...
ALTER TABLE FORCE_FIELD_DICTIONARY ADD CONSTRAINT FK_FF_DICTIONARY_FF_TYPE_DICTIONARY 
	FOREIGN KEY (type_id) REFERENCES FORCE_FIELD_TYPE_DICTIONARY (id)
;
...
ALTER TABLE MOLECULE_FUNCTIONAL_GROUP_REL ADD CONSTRAINT FK_FUNCTI_GROUP_REL_DICTIONARY 
	FOREIGN KEY (functional_group_id) REFERENCES FUNCTIONAL_GROUP_DICTIONARY (id)
;
...
ALTER TABLE PERIODIC_TABLE ADD CONSTRAINT FK_PERIODIC_TABLE_ELEMENT_FAMILY_DICT 
	FOREIGN KEY (family_id) REFERENCES ELEMENT_FAMILY_DICT (id)
;
...
ALTER TABLE QM_METHOD_CLASS_DICTIONARY ADD CONSTRAINT FK_QM_METHOD_CLASS_FAMILY 
	FOREIGN KEY (family_id) REFERENCES QM_METHOD_FAMILY_DICTIONARY (id)
;

ALTER TABLE QM_METHOD_DICTIONARY_CLASS_DICTIONARY ADD CONSTRAINT FK_QM_METHOD_CLASS_REL_CLASS 
	FOREIGN KEY (class_id) REFERENCES QM_METHOD_CLASS_DICTIONARY (id)
;

ALTER TABLE QM_METHOD_DICTIONARY_CLASS_DICTIONARY ADD CONSTRAINT FK_QM_METHOD_CLASS_REL_METHOD 
	FOREIGN KEY (method_id) REFERENCES QM_METHOD_DICTIONARY (id)
;

ALTER TABLE QM_PARAMETER_SET ADD CONSTRAINT FK_QM_METHOD_TO_DICTIONARY 
	FOREIGN KEY (std_method_id) REFERENCES QM_METHOD_DICTIONARY (id)
;
...
ALTER TABLE RESIDUE_OCCURRENCE ADD CONSTRAINT FK_RESIDUE_RESIDUE_DICT 
	FOREIGN KEY (definition_id) REFERENCES RESIDUE_DICT (id)
;
...
ALTER TABLE STANDARD_DATA_GENERATING_METHOD ADD CONSTRAINT FK_STD_DATA_GEN_METHOD_TYPE 
	FOREIGN KEY (type_id) REFERENCES STANDARD_DATA_GENERATING_METHOD_TYPE (id)
;
