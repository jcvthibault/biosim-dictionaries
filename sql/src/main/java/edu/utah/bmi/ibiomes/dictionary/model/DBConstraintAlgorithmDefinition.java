...
/**
 * Constraints algorithm definitions
 * @author Julien Thibault, University of Utah
 *
 */
@Entity
@Table(name="BIOSIM_DICT_CONSTRAINT_ALGORITHM")
public class DBConstraintAlgorithmDefinition {
	...
	public DBConstraintAlgorithmDefinition(){}
