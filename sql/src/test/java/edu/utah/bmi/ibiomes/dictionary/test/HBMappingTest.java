...
import edu.utah.bmi.ibiomes.dictionary.model.DBAtomicElement;
import edu.utah.bmi.ibiomes.dictionary.model.DBAtomicElementFamily;
import edu.utah.bmi.ibiomes.dictionary.model.DBBarostatDefinition;
import edu.utah.bmi.ibiomes.dictionary.model.DBBasisSetDefinition;
import edu.utah.bmi.ibiomes.dictionary.model.DBBasisSetTypeDefinition;
import edu.utah.bmi.ibiomes.dictionary.model.DBCalculationDefinition;
import edu.utah.bmi.ibiomes.dictionary.model.DBCalculationTypeDefinition;
import edu.utah.bmi.ibiomes.dictionary.model.DBConstraintAlgorithmDefinition;
import edu.utah.bmi.ibiomes.dictionary.model.DBEnhancedSamplingMethodDefinition;
import edu.utah.bmi.ibiomes.dictionary.model.DBEnsembleTypeDefinition;
import edu.utah.bmi.ibiomes.dictionary.model.DBFileFormatDefinition;
...
public class HBMappingTest {
	...
	public void testSelect() throws Exception
	{
		...
		try{
	        ...
	        session = sessionFactory.openSession();
	        session.beginTransaction();
			List<DBEnhancedSamplingMethodDefinition> samplMethods = session.createQuery("from DBEnhancedSamplingMethodDefinition").list();
	        session.getTransaction().commit();
	        session.close();
